...
export class ManuscriptService {
  ...
  constructor(
    @InjectModel('Manuscript') private readonly manuscriptModel: Model<Manuscript>,
   ...
   */
  async addManuscript(addManuscriptDto: AddManuscriptDto): Promise<ResponsePayload> {
  ...
  async getManuscriptById(id: string, select: string): Promise<ResponsePayload> {
    try {
